...
final class DataPackageTests: XCTestCase {
    ...
    func testJSONDataPackageRejectsUnknownTaskTagsFieldInPreferences() throws {
        let canonical = try SuntraceDataPackage.encode(try makeEngine().snapshot())
    ...
    func testJSONDataPackageRejectsEnvelopeMissingFormatVersion() throws {
        let encoded = try SuntraceDataPackage.encode(try makeEngine().snapshot())
        var envelope = try XCTUnwrap(
    ...
    func testJSONDataPackageRejectsTraceClassificationEventWithoutRevisionFact() throws {
        ...
        XCTAssertThrowsError(
            try SuntraceDataPackage.decode(
    ...
    func testJSONDataPackageRejectsNonFiniteDateFacts() throws {
        ...
        XCTAssertThrowsError(try SuntraceDataPackage.encode(snapshot))
    ...
    func testJSONDataPackageRoundTripsMergeRelationHistoryAndDeletionTombstone() throws {
        ...
        let data = try SuntraceDataPackage.encode(engine.snapshot())
        let restored = try SuntraceDataPackage.decode(data)
    ...
    func testCurrentDataPackagePreservesSubMillisecondClassificationAuditTimes() throws {
        ...
        let encoded = try SuntraceDataPackage.encode(engine.snapshot())
        ...
        let restored = try SuntraceDataPackage.decode(encoded)
    ...
    private func encodeCurrentFixture(_ snapshot: SuntraceSnapshot) throws -> Data {
        let encoder = JSONEncoder()
