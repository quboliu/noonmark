...
- 2026-07-06：详情态视觉回归已纳入默认门禁，当前基线为：day-detail `changed_ratio=0.151978`，day-manual-detail `0.151978`，day-review-saved `0.136030`，pool-detail `0.093695`，future-detail `0.065242`，unfinished-detail `0.151194`，completed-detail `0.159006`。详情态阈值先以防回归为主，后续 UI 复原会逐页收紧。
