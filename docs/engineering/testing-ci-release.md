...
- 2026-07-06：当前多页面视觉指标为：day `changed_ratio=0.181326`，pool `0.068325`，future `0.054931`，unfinished `0.101941`，completed `0.163664`，calendar `0.075058`，settings `0.049201`；Day Todo 和已完成池仍是下一轮 UI 收紧重点。
