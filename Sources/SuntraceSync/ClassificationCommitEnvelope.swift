...
/// `ClassificationPlan`，也不携带整份 `TaskClassificationState` 或 `SuntraceSnapshot`。
...
public enum ClassificationCommitApplyResult: Equatable, Sendable {
    case applied(SuntraceSnapshot)
    case duplicate(SuntraceSnapshot)
