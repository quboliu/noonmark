...
private struct DataPackageEnvelope: Codable {
    ...
    init(formatVersion: Int, snapshot: SuntraceSnapshot) {
...
private extension SuntraceDataPackage {
    ...
    static func validateUniqueFields(_ snapshot: SuntraceSnapshot) throws {
    ...
    static func validateTodoReferences(_ snapshot: SuntraceSnapshot) throws {
        let chainIDs = Set(snapshot.chains.map(\.id))
