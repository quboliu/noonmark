...
本轮只运行固定 `e2e` profile，不启动或读取 production。修复已随 `1e2f45ad68a821e24d76a0d6442418f3d338aed9` 进入版本历史；若回归，停止交付并回退整个飞光 Composer cutover，不得通过放大窗口、缩短错误文案或隐藏导航掩盖尺寸所有权故障。
